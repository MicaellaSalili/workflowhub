      ...
      <div className="bg-[#121216] rounded-2xl p-6 border border-slate-800 shadow-xl">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 bg-[#0a0a0c] p-2.5 rounded-xl border border-slate-800 shrink-0">
            <div className="w-9 h-9 rounded-lg bg-indigo-600/20 border border-indigo-500/30 text-indigo-300 font-bold flex items-center justify-center text-xs">
              {currentUser.avatar}
            </div>
            <div>
            ...
            {!isAdmin && (
              <button
                ...
                className="ml-2 px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-xs font-semibold flex items-center gap-1 transition-all shadow-md shadow-indigo-600/30 cursor-pointer"
              >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-[#121216] p-4 rounded-xl border border-slate-800 shadow-md">
          ...
          <div className="text-[11px] text-slate-400 mt-1 flex items-center gap-2">
            ...
            <span>&bull;</span>
            <span className="text-purple-400">{adminsCount} Admins</span>
          </div>
        </div>
        ...
        <div className="bg-[#121216] p-4 rounded-xl border border-slate-800 shadow-md">
          ...
          <div className="text-[11px] text-slate-400 mt-1 flex items-center gap-2">
            ...
            <span>&bull;</span>
            <span>RAM: <strong className="text-indigo-300">{telemetryStats.memoryUsageMb}MB</strong></span>
          </div>
        </div>
      </div>
          ...
          <div className="bg-[#121216] rounded-2xl p-4 border border-slate-800 shadow-md flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 bg-[#0a0a0c] border border-slate-800 rounded-lg text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-indigo-500"
              />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className="px-3.5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-xs font-semibold flex items-center gap-1.5 transition-all shadow-lg shadow-indigo-600/30 cursor-pointer"
              >
                      ...
                      return (
                        <tr 
                          ...
                          className={`hover:bg-[#16161c] transition-colors ${
                            isCurrentActivePersona ? 'bg-indigo-950/20' : ''
                          }`}
                        >
                          {/* User Identity */}
                          ...
                          <td className="py-3.5 px-4 text-slate-300">
                            <span className="font-mono text-xs text-indigo-300">{user.storageQuotaMb || 1024} MB</span>
                          ...
                          <td className="py-3.5 px-4 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              <button
                                ...
                                className="p-1.5 bg-slate-900 hover:bg-indigo-600 hover:text-white text-slate-400 border border-slate-800 rounded transition-all cursor-pointer"
            ...
            <div className="bg-[#121216] rounded-2xl p-5 border border-slate-800 shadow-md md:col-span-2 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
                ...
                <div className="bg-[#0a0a0c] p-3 rounded-xl border border-slate-800">
                  ...
                  <div className="text-xs font-bold text-indigo-400 mt-0.5">15 Minutes</div>
                </div>
                <div className="bg-[#0a0a0c] p-3 rounded-xl border border-slate-800">
            ...
            <div className="bg-[#121216] rounded-2xl p-5 border border-slate-800 shadow-md space-y-4">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex items-center justify-between p-2 rounded-lg bg-[#0a0a0c] border border-slate-800">
                  ...
                  <span className="font-bold text-indigo-400">2.1 ms</span>
                </div>
                <div className="flex items-center justify-between p-2 rounded-lg bg-[#0a0a0c] border border-slate-800">
          ...
          <div className="bg-[#0a0a0c] rounded-2xl border border-slate-800 shadow-md p-4 max-h-[600px] overflow-y-auto font-mono text-xs space-y-2">
            {filteredLogs.length === 0 ? (
              ...
              filteredLogs.map(log => {
                ...
                if (log.level === 'SECURITY') badgeStyle = 'bg-purple-500/20 text-purple-300 border-purple-500/30';
            ...
            <form onSubmit={handleSendBroadcast} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 text-xs bg-[#0a0a0c] border border-slate-800 rounded-lg text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500"
                />
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                <span className="text-[11px] text-slate-500">
                  Transmitted via: <code className="text-indigo-300">Clients.All.SystemBroadcastReceived()</code>
                </span>
                <button
                  type="submit"
                  disabled={!broadcastTitle || !broadcastMessage || isBroadcasting}
                  className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-40 text-white rounded-lg text-xs font-semibold flex items-center gap-1.5 transition-all shadow-lg shadow-indigo-600/30 cursor-pointer"
                >
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-[#121216] rounded-2xl p-5 border border-slate-800 shadow-md space-y-3">
              ...
              <button
                ...
                className="w-full py-2 bg-slate-900 hover:bg-purple-600 hover:text-white border border-slate-800 text-slate-300 rounded-lg text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
                <Zap className="w-3.5 h-3.5" />
          ...
          <div className="bg-[#121216] rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-800 text-slate-200 animate-in fade-in zoom-in-95 duration-150">
            ...
            <form onSubmit={handleCreateUser} className="mt-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2 text-xs bg-[#0a0a0c] border border-slate-800 rounded-lg text-slate-200 focus:outline-none focus:border-indigo-500 cursor-pointer"
                  >
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-800">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 text-xs font-semibold bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg transition-all shadow-lg shadow-indigo-600/30 flex items-center gap-1.5 cursor-pointer"
                >
                  <UserPlus className="w-3.5 h-3.5" />
                  Provision User
                </button>
            ...
            <form onSubmit={handleSaveEditUser} className="mt-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 text-xs bg-[#0a0a0c] border border-slate-800 rounded-lg text-slate-100 focus:outline-none focus:border-indigo-500"
                />
              </div>
